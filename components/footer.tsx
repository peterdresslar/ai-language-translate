...
export default function Footer() {
  return (
    <Container>
      <div className="flex flex-wrap mx-0 md:mx-0 justify-center md:justify-between">
        ...
        <div className="min-w-[300px] text-center md:text-end">
          <div className="flex flex-wrap w-full lg:ml-0">
            <a href="https://www.pacificbroadband.org/2023/09/01/can-ai-grasp-pacific-languages-inside-our-push-for-an-ai-samoan-translator/" className="w-full mt-2 ml-3 text-gray-500 dark:text-gray-400">
              Blog
            </a>
          </div>
          <div className="flex flex-wrap w-full lg:ml-0">
            <a href="https://github.com/peterdresslar/ai-language-translate" className="w-full mt-2 ml-3 text-gray-500 dark:text-gray-400">
              Source Code
            </a>
          </div>
        </div>
